...
TARGET_COLLECTION = "bible_ar" # Unified collection

BATCH_BIBLES = [
    {"id": "shr", "name": "Shi"},
    {"id": "rifa", "name": "Tarifit"},
    {"id": "bel", "name": "Belarusian"},
    {"id": "lin", "name": "Lingála"},
    {"id": "lug", "name": "Luganda"},
    {"id": "nya", "name": "Chichewa"},
    {"id": "cebulb", "name": "Cebuano"},
    {"id": "hatbsa", "name": "Haitian"},
    {"id": "ibo", "name": "Igbo"},
    {"id": "som", "name": "Somali"},
    {"id": "gaz", "name": "Oromo"},
    {"id": "haw1868", "name": "Hawaiian"},
    {"id": "iloulb", "name": "Ilocano"},
    {"id": "ton", "name": "Tongan"},
    {"id": "gun", "name": "Guarani"},
    {"id": "kik", "name": "Gikuyu"},
    {"id": "twi", "name": "Twi"},
    {"id": "chk", "name": "Chuukese"},
    {"id": "bis", "name": "Bislama"},
    {"id": "rar", "name": "Rarotongan"}
]
    ...
    for bible in BATCH_BIBLES:
        ...
        for i in range(0, len(verses), batch_size):
            ...
            try:
                ...
                time.sleep(1)
        print(f"   Successfully imported {bname}")
